...
class parser:
    ...
    def parse_data(self, data):
        ...
        self.R_ShoulderF = math.radians((struct.unpack('h', data[130:132])[0]) * 0.085)
        self.R_Shoulder_S = math.radians((struct.unpack('h', data[284:286])[0] - 2150) * 0.08789063 ) # correct
        self.R_ElbowR = math.radians((struct.unpack('h', data[278:280])[0] - 2018) * 0.08789063  )# correct
        self.R_Elbow = math.radians(struct.unpack('h', data[162:164])[0] * -0.02 ) # correct
        self.R_WristR = math.radians((-4520 - struct.unpack('h', data[146:148])[0]) * 0.085 ) # correct
        self.R_WristS = math.radians(((0 - struct.unpack('h', data[282:284])[0]) + 2040) * 0.08789063 ) # incorrect?
        self.R_WristF = math.radians(((0 - struct.unpack('h', data[280:282])[0]) + 2160) * 0.08789063)
