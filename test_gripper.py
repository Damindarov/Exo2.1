...
robot2.set_standard_digital_out(1, True)
time.sleep(2)
robot2.set_standard_digital_out(1, False)
robot2.set_standard_digital_out(0, False)

robot2.set_standard_digital_out(0, True)
time.sleep(2)
robot2.set_standard_digital_out(0, False)
